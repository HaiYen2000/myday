...
import com.fox.myday.listeners.OnToggleAuthenticateListener;
...
public class LoginButton extends View {
    ...
    private OnToggleAuthenticateListener callback;
...
//        animator.setInterpolator(new AccelerateInterpolator());
    ...
    public void setOnButtonSwitched(OnToggleAuthenticateListener callback) {
    ...
    public void setOnSignUpListener(OnRegisterListener listener) {
