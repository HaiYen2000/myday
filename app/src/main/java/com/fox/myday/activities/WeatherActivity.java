...
import com.fox.myday.tasks.GenericRequestTask;
import com.fox.myday.tasks.ParseResult;
import com.fox.myday.tasks.TaskOutput;
import com.fox.myday.utils.Formatting;
...
import static com.fox.myday.Constants.MY_PERMISSIONS_ACCESS_FINE_LOCATION;
import static com.fox.myday.Constants.NO_UPDATE_REQUIRED_THRESHOLD;
import static com.fox.myday.utils.TimeUtils.isDayTime;

public class WeatherActivity extends WeatherBaseActivity implements LocationListener {
