...
public class IntroActivity extends BaseActivity {
    ...
    private IntroViewPagerAdapater introViewPagerAdapater;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        introViewPagerAdapater = new IntroViewPagerAdapater(IntroActivity.this, layouts);
        viewPager.setAdapter(introViewPagerAdapater);
    ...
    private void launchHomeScreen() {
        ...
        //startActivity(new Intent(IntroActivity.this, UserAuthenticationActivity.class));
